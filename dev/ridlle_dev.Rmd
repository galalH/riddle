...
#' dataset keywords
#'
#' As extracted from the \href{https://github.com/okfn/ckanext-unhcr/blob/master/ckanext/unhcr/schemas/dataset.json}{dataset schema}.
#'
#' @format A named character vector mapping user-visible labels (the names) to their corresponding codes in the system (the values).
"keywords"
...
test_that("dataset works", {
  expect_true(inherits(dataset, "function")) 
})
```
...
test_that("search works", {
  expect_true(inherits(dataset_search, "function")) 
})
```
...
test_that("resource_metadata works", {
  expect_true(inherits(resource_metadata, "function")) 
})
```
...
```{r tests-ressource}
test_that("ressource works", {
  expect_true(inherits(ressource, "function")) 
})
```
...
test_that("summary_report works", {
  expect_true(inherits(summary_report, "function")) 
})
```
